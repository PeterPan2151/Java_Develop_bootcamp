...
public class Pokerito {
    public static void main(String[] args) {
        ...
        */
        ...
        for (int i = 0; i < 5; i++) {
            scan.nextLine();
            String placeHolderCard = randomCard();
            if (placeHolderCard.equals(playersCard)) {
                yourMatches++;
            }
            if (placeHolderCard.equals(computersCard)) {
                computerMatches++;
            }
            System.out.println("Card " + (i + 1) + "\n");
            System.out.println(placeHolderCard);
        }
